...
namespace Bb.Diagnostics
{
    ...
    /// </summary>
    public static class HttpActivityProvider
    {
        ...
        /// </summary>
        static HttpActivityProvider()
        {
            Name = nameof(HttpActivityProvider);
            Name = Name.Substring(0, Name.Length - "Provider".Length);
            Version = typeof(HttpActivityProvider).Assembly.GetName().Version;
