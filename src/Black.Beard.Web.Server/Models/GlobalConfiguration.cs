...
namespace Bb.Models
{
    ...
    public class GlobalConfiguration
    {
        ...
        public GlobalConfiguration()
        {
            ...
            this.UseSwagger = "use_swagger".EnvironmentVariableExists()
                ? "use_swagger".EnvironmentVariableIsTrue()
                : GlobalConfiguration.IsDevelopment;

            this.TraceAll = "trace_all".EnvironmentVariableExists()
                ? "trace_all".EnvironmentVariableIsTrue()
                : GlobalConfiguration.IsDevelopment;

            this.UseTelemetry = "use_telemetry".EnvironmentVariableExists()
