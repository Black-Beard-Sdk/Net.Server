...
namespace Bb.Servers.Web.Swashbuckle
{
        ...
        where T : class
    {
        ...
        public AddDiscriminatorOnKnownTypesSchemaFilter(string propertyName)
        {
            ...
            _propertyInfo = _type.GetProperties(BindingFlags.Instance | BindingFlags.Public).Where(c => c.Name == _propertyName && c.CanRead).FirstOrDefault();
